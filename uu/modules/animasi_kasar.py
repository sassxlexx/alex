...
async def _(client, message):
    await message.edit("**WOYY NGENTOD!!**")
...
@PY.UBOT("goblok")
async def _(client, message):
    await message.edit("**WOYY GOBLOK!!**")
    await asyncio.sleep(1)
...
@PY.UBOT("yatim")
async def _(client, message):
    await message.edit("`Hai Anak Kontol 🙈, Jangan Lupa Makan Yaa`")
    await asyncio.sleep(1)
    ...
    await asyncio.sleep(1)
    await message.edit("`Tapi Bo'ong Hiyahiyahiya`")



@PY.UBOT("kontol")
async def _(client, message):
    await message.edit("**LU KONTOLL**")
    ...
    await asyncio.sleep(1.5)
    await message.edit("**KASIAN CACAD GAPUNYA KONTOLL**")


@PY.UBOT("hina")
async def _(client, message):
    await message.edit("**IZIN PANTUN BANG...**")
    ...
    await asyncio.sleep(1.8)
    await message.edit("**GA USAH SO KERAS DEH LU KALO MENTAL BLOM SEKERAS BAJA...**")
    await asyncio.sleep(1.8)
...
@PY.UBOT("alay")
async def _(client, message):
    await message.edit("**Eh Kamu Ganteng-ganteng**")
    await asyncio.sleep(1.8)
    ...
    await asyncio.sleep(1.8)
    await message.edit("**Pantes Norak Xixixi**")



@PY.UBOT("ngaca")
async def _(client, message):
    await message.edit("**IZIN NUMPANG PANTUN BANG...**")
    await asyncio.sleep(1.8)
    ...
    await asyncio.sleep(1.8)
    await message.edit("**UDAH BULUK ITEM PENDEK BERPONI BAJU KEGEDEAN KAYAK JAMET**")
    await asyncio.sleep(1.8)
    await message.edit("**UDAH BULUK ITEM SOK-SOK AN MAU NGEHINA GUA KONTOL**" )
    await asyncio.sleep(1.8)
    await message.edit("**KENA KAN MENTAL LU...**")


@PY.UBOT("santet")
async def santet(client: Client, message: Message):
    typew = await message.edit("ᴍᴇɴɢᴀᴋᴛɪғᴋᴀɴ ᴘᴇʀɪɴᴛᴀʜ sᴀɴᴛᴇᴛ ᴏɴʟɪɴᴇ...")
    await asyncio.sleep(2)
    await typew.edit("ᴍᴇɴᴄᴀʀɪ ɴᴀᴍᴀ ᴏʀᴀɴɢ ɪɴɪ...")
    await asyncio.sleep(1)
    await typew.edit("sᴀɴᴛᴇᴛ ᴏɴʟɪɴᴇ sᴇɢᴇʀᴀ ᴅɪʟᴀᴋᴜᴋᴀɴ...")
    await asyncio.sleep(1)
    await typew.edit("0%")
    number = 1
    ...
    await typew.edit(str(number) + "%   ████████████████▌")
    await asyncio.sleep(1)
    await typew.edit("<b>ᴛᴀʀɢᴇᴛ ʙᴇʀʜᴀsɪʟ ᴛᴇʀsᴀɴᴛᴇᴛ ᴏɴʟɪɴᴇ 🥴</b>")